...
const QuestionCard: React.FC<QuestionCardProps> = ({
  ...
  // Question time limit timer (30 seconds)
  useEffect(() => {
  ...
  return (
    <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-purple-100 p-8 max-w-5xl mx-auto overflow-hidden">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4 text-white/90">
            ...
            <div className={`flex items-center space-x-2 backdrop-blur-sm px-4 py-2 rounded-full font-bold ${getTimerColor()} text-black ${questionTimer <= 10 ? 'animate-pulse' : ''}`}>
              ...
              <span className="font-mono text-lg">{questionTimer}s</span>
            </div>
        ...
        {questionTimer <= 10 && !isSubmitted && (
          <div className="bg-red-50 border-2 border-red-200 rounded-xl p-4 mb-4">
            <div className="flex items-center space-x-2 text-red-700">
              ...
              <span className="font-bold">Time Warning: Only {questionTimer} seconds remaining!</span>
            </div>
          </div>
        )}
      </div>
      ...
      {!isSubmitted ? (
        <div className="space-y-6">
          <div className="relative">
            <Textarea
              ...
              className="min-h-[160px] text-lg border-2 border-purple-200 focus:border-purple-500 transition-all duration-300 rounded-2xl p-6 bg-gradient-to-br from-purple-50/50 to-pink-50/50 resize-none"
          ...
          <div className="flex justify-between items-center">
            ...
            <Button
              ...
              className="bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 hover:from-purple-600 hover:via-pink-600 hover:to-blue-600 text-white px-10 py-4 rounded-2xl font-bold disabled:opacity-50 shadow-lg transform hover:scale-105 transition-all duration-200 flex items-center space-x-2 text-lg"
            >
        ...
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-2xl p-8">
          <div className="text-center">
            ...
            <h4 className="text-green-800 font-bold text-2xl mb-3">
